...
public class BattleFacade {
    ...
    public void battle(Game game, Player player, Enemy enemy) {
        ...
        if (effectivePotion != null) {
            ...
            // preivous setting is player.getInventory().getEntities(BattleItem.class)
        ...
        List<Mercenary> mercs = game.getEntitiesWithClass(Mercenary.class);
