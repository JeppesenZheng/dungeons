...
public class Portal extends Entity implements OverlapInterface {
    ...
    public boolean canTeleportTo(GameMap map, Entity entity) {
        List<Position> neighbours = getAllCardinallyAdjacentPositions();
    ...
    private void doTeleport(GameMap map, Entity entity) {
        Position destination = pair.getAllCardinallyAdjacentPositions()
                .stream()
    ...
    public List<Position> getDestPositions(GameMap map, Entity entity) {
        return pair == null
                ? null
                : pair.getAllCardinallyAdjacentPositions()
                    .stream()
