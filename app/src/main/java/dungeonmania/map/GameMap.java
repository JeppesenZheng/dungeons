...
import dungeonmania.entities.OnDestroyInterface;
import dungeonmania.entities.OnmoveInterface;
...
public class GameMap {
    ...
    private void triggerMovingAwayEvent(Entity entity) {
        ...
        getEntities(entity.getPosition()).forEach(e -> {
            if (e != entity && e instanceof OnmoveInterface)
                callbacks.add(() -> ((OnmoveInterface) e).onMovedAway(this, entity));
        });
    ...
    private void triggerOverlapEvent(Entity entity) {
        ...
        getEntities(entity.getPosition()).forEach(e -> {
            if (e != entity && e instanceof OverlapInterface)
                overlapCallbacks.add(() -> ((OverlapInterface) e).onOverlap(this, entity));
        });
    ...
    public void destroyEntity(Entity entity) {
        removeNode(entity);
        if (entity instanceof OnDestroyInterface) {
            ((OnDestroyInterface) entity).onDestroy(this);
        }
    }
