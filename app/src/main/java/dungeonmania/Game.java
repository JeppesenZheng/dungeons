...
public class Game {
    ...
    public Game build(String buildable) throws InvalidActionException {
        ...
        if (buildables.contains("midnight_armour") && !noZombieToasts()) {
            throw new InvalidActionException(String.format("%s cannot be built", buildable));
        }
    ...
    public <T> List<T> getEntitiesWithClass(Class<T> type) {
    ...
    public boolean checkHasSpawner() {
        List<ZombieToastSpawner> zombieToastSpawners = getEntitiesWithClass(ZombieToastSpawner.class);
        return zombieToastSpawners.isEmpty();
    }

    public int getKillEnemyCount() {
        return player.getKillEnemyCount();
    }

    public boolean noZombieToasts() {
        return getEntitiesWithClass(ZombieToast.class).isEmpty();
    }
}
