...
public class NameConverter {
    public static String toSnakeCase(Entity entity) {
        ...
        if (entity instanceof LightBulb) {
            String lightBulb = ((LightBulb) entity).isActivated() ? "light_bulb_on" : "light_bulb_off";
            return lightBulb;
        }
        if (entity instanceof SwitchDoor) {
            String switchDoor = ((SwitchDoor) entity).isActivated() ? "switch_door_open" : "switch_door";
            return switchDoor;
        }
        return nameBasic;
    }
